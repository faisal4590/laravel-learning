  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./img/logo.jpg" alt="logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Laravel Learning</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/dashboard" class="nav-link">
              <i class="nav-icon fa fa-tachometer-alt icon-blue"></i>
              <p>
                Dashboard
              </p>
            </router-link>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa-cogs icon-pink"></i>
              <p>
                Manage
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('logout') }}"
                                ...
                                <i class="nav-icon fa fa-power-off icon-orange"></i>
                        <p>
                            {{ __('Logout') }}
                        </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
          <router-view>
          <!-- Eta amar main router. Tai main content er moddhe router define korlam
           jokhn kono kisu te click korbo tokhn chabo kono component load kore ei view te
           show korabo
           -->
          </router-view>
